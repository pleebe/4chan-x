DeleteLink =
  ...
  load: (link, post, fileOnly, resDoc) ->
    ...
    if resDoc.title is '4plebs - Banned' # Ban/warn check
      el = $.el 'span', <%= html('You can&#039;t delete posts because you are <a href="//www.4plebs.org/banned" target="_blank">banned</a>.') %>
